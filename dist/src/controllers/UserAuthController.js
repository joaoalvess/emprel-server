...
var UserAuthController = /** @class */ (function () {
    ...
    UserAuthController.prototype.show = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, senha, auth;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = request.query, email = _a.email, senha = _a.senha;
                        return [4 /*yield*/, connection_1.default('users').where('email', String(email)).where('senha', String(senha)).first()];
                    case 1:
                        auth = _b.sent();
                        if (!auth) {
